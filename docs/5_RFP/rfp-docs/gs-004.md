...
[Neo X introduces MEV protection](neo-blockchain.medium.com/neo-x-mainnet-v0-4-2-upgrade-anti-mev-now-live-b72e3d89e14b) (Maximum Extractable Value) to help secure transactions from [MEV-related risks](https://neo-blockchain.medium.com/how-neo-eliminates-toxic-mev-d0ecd3ff5717). We want to educate the community and provide real-world examples that other developers can reference. By keeping these projects small and focused, we aim to build a library of tutorial-like demos that illustrate the use of MEV resistance in the Neo ecosystem.
...
- Proposals must be submitted through the GrantShares dApp under "Request for Funding" by **5th Novemeber**.
